/**Variable wanderlust_wiz_members  that is an array containing objects, 
 * where each object represents a member
 *Each object within the array contains three properties: name, position and bio*/
...
/**The 'about us' function fetches elements from the 'about us' container. 
 * It generates an 'h1' element with the heading 'About Us' 
 * as its text content and also creates a section named 'Wanderlust Wiz Team.*/
...
function aboutUs() {
    ...
    /**For each member, the function displays their name (as an 'h3' element), 
     * position (as a 'p' element), 
     * and a brief biography bio (also as a 'p' element). */
